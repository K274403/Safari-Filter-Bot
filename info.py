...
QR_CODE = environ.get('QR_CODE', 'https://envs.sh/GoQ.jpg') # Scanner Code image 
...
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "looterekrish") # widout 👉 @
...
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002023191399'))
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002023191399'))
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'True')), False)

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Leech0:Leech@cluster0.jxby6.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DATABASE_NAME = environ.get('DATABASE_NAME', "Leech0")
